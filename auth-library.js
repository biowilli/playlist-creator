...
export async function getAccessTokenWithLibraryScope() {
  return new Promise((resolve, reject) => {
    ...
    console.log('\n🎵 Spotify Library Access Required');
    console.log('Please open this URL in your browser to authorize library access:');
    console.log(`\n${authUrl}\n`);
    ...
    app.get('/callback', async (req, res) => {
      ...
      try {
        ...
        if (tokenData.access_token) {
          res.send(`
            <h1>✅ Library Access Authorized!</h1>
            <p>You can now close this browser tab and return to the terminal.</p>
            <p>Organizing your library by genre...</p>
          `);
          server.close();
